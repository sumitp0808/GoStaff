...
//         if(!employee) {
//             return res.status(404).json({success: false, error: "employee not found to update salary"});
//         }
...
//         return res.status(200).json({success: true, message: "employee salary updated"})
//     } catch(error){
